  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link
          to="/dashboard/institutions/create"
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">All Institutions</h3>
        </div>
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                placeholder="Enter unique institution code"
              />
            </div>
          </div>
          ...
          <div>
            <label htmlFor="isActive" className="flex items-center">
              <input
                ...
                defaultChecked
              />
              <span className="ml-2 text-sm text-gray-900">Active Institution</span>
            </label>
            <p className="mt-1 text-sm text-gray-500">
              Inactive institutions will not be available for user registration
            </p>
          </div>
...
// Empty components for Teacher and Officer dashboards
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Teacher Features Coming Soon</h3>
          <p className="mt-1 text-sm text-gray-500">Teacher-specific features will be available here.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Welcome to your officer dashboard</p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Officer Features Coming Soon</h3>
          <p className="mt-1 text-sm text-gray-500">Officer-specific features will be available here.</p>
        </div>
      </div>
    </div>
  );
...
export { AdminInstitutions, CreateInstitution, AdminUsers, TeacherDashboard, OfficerDashboard };